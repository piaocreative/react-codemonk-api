...
module.exports = {
    ...
    async up (db, client) {
        const destinationDocument = 'users';
        const query = { 'registerType': 'individual' };
...
async function fetchSourceDocuments (db, sourceDocument, query, limit, page, select = { userId: 1 }, sort = { 'createdAt': -1 }) {
