 ...
 */
class AddJobPostValidator extends validation {
    ...
    async addJobPost() {
        ...
        await this.jobPostValidation();
    }

    async jobPostValidation() {
        ...
        await this.checkSkills(this.body.skills);
...
module.exports = AddJobPostValidator;
