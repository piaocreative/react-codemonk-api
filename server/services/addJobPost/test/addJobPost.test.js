...
const TestCase = require('./addJobPost');
chai.use(chaiHttp);
...
describe('Admin add job post', () => {
    try {
        ...
        it('As a admin, I should able to add job post', async () => {
        ...
        it('As a admin, I should able to add job post with empty teamPreference and assignment', async () => {
            const JobPostDetails = {
                projectName: '5f631e56d37cbb4801f0fa45',
        ...
        it('As a admin, I should able to add job post without empty teamPreference and assignment', async () => {
            const JobPostDetails = {
                projectName: '5f631e56d37cbb4801f0fa45',
                name: 'Codemonk second brief',
                clientId: client.id,
        ...
        it('As a admin, I should not able to add job post without clientId', async () => {
            const JobPostDetails = {
                projectName: '5f631e56d37cbb4801f0fa45',
                name: 'Codemonk second brief',
                description: `<p>Contrary to popular belief, Lorem Ipsum is not simply random text.
        ...
        it('As a client, I should able to add job post without empty teamPreference and assignment', async () => {
            const JobPostDetails = {
                projectName: '5f631e56d37cbb4801f0fa45',
                name: 'Codemonk second brief',
                description: `<p>Contrary to popular belief, Lorem Ipsum is not simply random text.
        ...
        it('As a client, I should able to add job post with project name', async () => {
            const JobPostDetails = {
                'projectName': 'abcd',
                'name': 'Brief Test 1',
