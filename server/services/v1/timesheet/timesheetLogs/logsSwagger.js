...
module.exports = swaggerJson => {
    swaggerJson.paths['/timesheet/{id}/logs'] = {
        get: {
            security: [{
                bearerAuth: []
            }],
            ...
            description: 'Timesheet logs',
            summary: 'Timesheet logs',
            responses: {
                200: {
                    description: 'Timesheet logs',
                    schema: {
                        $ref: '#/definitions/timesheetLogsSuccess'
                    }
                },
                400: {
    ...
    swaggerJson.definitions.timesheetLogsSuccess = {
        properties: {
            status: {
                type: 'number',
                example: 1
