...
const TestCase = require('./editJobPostBasicDetails');
chai.use(chaiHttp);
...
describe('Edit job post basic details', () => {
    try {
        TestCase.edit.forEach((data) => {
            it(data.it, (done) => {
                request(process.env.BASE_URL)
                    .put('/job-post/basic-details')
        ...
        it('As a admin, I should able to edit job post basic details', async () => {
