...
module.exports = swaggerJson => {
  swaggerJson.paths['/algo-api/talent/{id}/rec_jobs'] = {
    get: {
      security: [{
        bearerAuth: []
      }],
      ...
      parameters: [{
        in: 'path',
        name: 'id',
        description: 'id in talent',
        example: '5f0c3ffc68f150000730d675'
      }],
      description: "Get recommended jobs from a talent Id",
      summary: "Get recommended jobs from a talent Id",
