...
module.exports = swaggerJson => {
  swaggerJson.paths['/v2/ambassador/talent/list'] = {
    get: {
      security: [{
        bearerAuth: []
      }],
      ...
      description: 'Get invited talent list',
      summary: 'Get invited talent list',
      responses: {
        200: {
          description: 'Get invited talent list',
          schema: {
            $ref: '#/definitions/referralListSuccessForAmbassador'
          }
        },
        400: {
  ...
  swaggerJson.definitions.referralListSuccessForAmbassador = {
    properties: {
      status: {
        type: 'number',
        example: 1
