...
const TestCase = require('./editJobPostPreferredCandidates');
chai.use(chaiHttp);
...
describe('Admin edit job post with preferred candidates', () => {
    try {
        TestCase.add.forEach((data) => {
            it(data.it, (done) => {
                request(process.env.BASE_URL)
                    .put('/job-post/preferred-candidates')
        ...
        it('As a admin, I should able to edit job post with preferred candidates', async () => {
