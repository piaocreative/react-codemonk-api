const recruiter = require('mongoose');
const Schema = recruiter.Schema;

const mongoosePaginate = require('mongoose-paginate-v2');
const aggregatePaginate = require('mongoose-aggregate-paginate-v2');
const Constants = require('../util/constants');

const schema = new recruiter.Schema({
    userId: {
    ...
    registerType: {
        type: String,
        enum: Constants.RECRUITER.REGISTER_TYPE,
        default: Constants.RECRUITER.REGISTER_TYPE[1]
    },
    billing: {
        type: {
            type: String,
...
module.exports = recruiter.model('recruiter', schema);
